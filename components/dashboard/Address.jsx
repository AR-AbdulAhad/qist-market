...
export default function Address() {
  ...
  const handleAreaChangeNew = (e) => {
    const area = e.target.value;
    setSelectedAreaNew(area);
    setNewAddress((prev) => ({ ...prev, area }));
    setNewAddressErrors((prev) => ({ ...prev, area: "" }));
  };

  const handleAreaChangeEdit = (e) => {
    const area = e.target.value;
    setSelectedAreaEdit(area);
    setEditAddressData((prev) => ({ ...prev, area }));
    setEditAddressErrors((prev) => ({ ...prev, area: "" }));
  };
  ...
  const handleEditAddress = (id) => {
    ...
    if (addressToEdit) {
      ...
      setSelectedAreaEdit(addressToEdit.area || "");
    }
  };
        ...
        >
          <div className="form-content">
            ...
            <fieldset>
              ...
              <Area
                cityName={selectedCityNew}
                value={selectedAreaNew}
                onChange={handleAreaChangeNew}
                disabled={!selectedCityNew}
              />
          ...
          >
            <div className="form-content">
              ...
              <fieldset>
                <label htmlFor="Area">Area</label>
                <Area
                  cityName={selectedCityEdit}
                  value={selectedAreaEdit}
                  onChange={handleAreaChangeEdit}
