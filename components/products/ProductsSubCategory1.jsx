...
export default function ProductsSubCategory1({ categorySlug, subCategorySlug }) {
            ...
            <div className="tf-shop-control flex-wrap gap-10">
              <div className="d-flex align-items-center gap-10">
                ...
                <p className="body-text-3">
                  <span className="count">{formatSlugName(subCategorySlug)} {formatSlugName(categorySlug)}</span>
                </p>
                |
                <p className="body-text-3">
